...
CUDA_DEVICE=2
BASE_CMD="nohup python train_advanced_ts.py --cuda_device 0 --data_name \"PHMFFT\" --data_dir \"./dataset/PHM2009\" --save_weights --domain_adversarial True --adversarial_loss DA --self_training True --self_training_criterion confidence --adaptive_confidence_threshold --calibration TempScaling --mcc_loss --sdat --checkpoint_dir output/cat_tempscaling_output"

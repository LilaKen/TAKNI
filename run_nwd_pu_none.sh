...
CUDA_DEVICE=0
BASE_CMD="nohup python train_advanced.py --model_name \"cnn_features_1d\" --cuda_device 0 --data_name \"PU\" --data_dir \"./dataset/PU\" --last_batch True --distance_metric True --distance_loss \"NWD\" "

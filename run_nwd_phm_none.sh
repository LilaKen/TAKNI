...
CUDA_DEVICE=2
BASE_CMD="nohup python train_advanced.py --model_name \"cnn_features_1d\" --cuda_device 0 --data_name \"PHM\" --data_dir \"./dataset/PHM2009\" --last_batch True --distance_metric True --distance_loss \"NWD\" "

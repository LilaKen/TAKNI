...
CUDA_DEVICE=3
BASE_CMD="nohup python train_advanced.py --model_name \"cnn_features_1d\" --cuda_device 0 --data_name \"CWRUFFT\" --data_dir \"./dataset/CWRU\" --last_batch True --distance_metric True --distance_loss \"NWD\" "

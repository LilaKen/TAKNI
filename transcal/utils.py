...
# from TransCal import cal_acc_error
...
def VectorOrMatrixScaling(logits, labels, outputs_target, labels_target, cal_method=None):
    ...
    return after_calibration_ece, final_output, (cal_model.W, cal_model.b)
...
class TransCal(nn.Module):
    ...
    def find_best_T(self, logits, weight, error, source_confidence):
        ...
        optimal_parameter = minimize(eval, np.array([100.0, 0.5]), method='SLSQP', bounds=bnds)  # original [2.0, 0.5]

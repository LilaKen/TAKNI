...
data = {
    'MK-MMD': [94.23, 86.42, 85.42, 95.53, 90.85, 95.39],
    'JMMD': [95.02, 86.83, 93.27, 96.59, 91.71, 92.01],
    'LJMMD': [93.38, 81.43, 84.98, 96.42, 91.37, 97.17],
    'CORAL': [81.71, 79.73, 77.85, 89.69, 80.85, 93.24],
    'DANN': [93.62, 86.25, 88.43, 95.60, 90.96, 92.56],
    'CDAN': [91.03, 86.59, 89.15, 95.90, 90.92, 92.56],
    'CAT': [85.36, 83.48, 70.72, 90.48, 80.27, 90.82],
    'Ours': [99.76, 99.83, 99.08, 99.93, 99.01, 99.66]
}
...
# 保存为 pdf 文件
plt.tight_layout()
plt.savefig("JNU_FRE.pdf", format='pdf', bbox_inches='tight')

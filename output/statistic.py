...
# 示例使用，适用于多个路径
paths = [
    # "cat_tempscaling_output/CWRU/None",  # 第一个路径
    # "cat_tempscaling_output/JNU/None",  # 第一个路径
    # "cat_tempscaling_output/PU/None",  # 第一个路径
    # "cat_tempscaling_output/PHM/None",  # 第一个路径
    "cat_tempscaling_output/SEU/None",  # 第一个路径
    #
    # "cat_tempscaling_output/CWRU/FFT",  # 第一个路径
    # "cat_tempscaling_output/JNU/FFT",  # 第一个路径
    # "cat_tempscaling_output/PU/FFT",  # 第一个路径
    # "cat_tempscaling_output/PHM/FFT",  # 第一个路径
    "cat_tempscaling_output/SEU/FFT",  # 第一个路径

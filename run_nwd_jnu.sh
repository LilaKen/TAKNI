...
CUDA_DEVICE=1
BASE_CMD="nohup python train_advanced.py --model_name \"cnn_features_1d\" --cuda_device 0 --data_name \"JNUFFT\" --data_dir \"./dataset/JNU\" --last_batch True --distance_metric True --distance_loss \"NWD\" "

...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='tam_features_1d', help='the name of the model')
    parser.add_argument('--data_name', type=str, default='PHM', help='the name of the data')
    parser.add_argument('--data_dir', type=str, default='dataset/PHM2009', help='the directory of the data')
    ...
    parser.add_argument('--bottleneck', type=bool, default=True, help='whether using the bottlenecks layer')
    parser.add_argument('--bottleneck_capsulenet', type=bool, default=False, help='whether using the capsulenet bottlenecks layer')
    parser.add_argument('--bottleneck_num', type=int, default=256, help='whether using the bottlenecks layer')
    ...
    parser.add_argument('--distance_loss', type=str, choices=['MK-MMD', 'JMMD', 'LJMMD', 'CORAL', 'MSKW'], default='MK-MMD',
                        help='which distance loss you use')
    ...
    parser.add_argument('--adversarial_loss', type=str, choices=['DA', 'CDA', 'CDA+E', 'UDAFDF', "None"], default='CDA+E',
                        help='which adversarial loss you use')
...
if __name__ == '__main__':
    ...
    sub_dir = args.model_name + '_' + args.data_name + '_' + domain_transfer + '_' + str(args.seed) + '_' + str(args.domain_adversarial) + '_'\
              + args.adversarial_loss + '_' + str(args.distance_metric) + '_' + args.distance_loss  + '_' + args.opt \
              + '_' + args.lr_scheduler
